...
The 18 ingested resumes are essentially **one career reframed for many target roles**. This page
catalogues the framings so the Apply operation can pick the closest starting point. The underlying
facts live in [[experience]]; this page is about *angle and emphasis*, not new history.

> All variants share the same employment history (Xero → Go1 → Suncorp → Virgin → intelliHR →
> Console/Reapit → 2sol → Emedia). What changes is the headline title, the professional summary,
> which roles are expanded vs. collapsed, and which "🔴 relevant experience" flags are added.
...
- **TPM / 15+ years:** "Technical Program Manager with 15+ years delivering high-complexity,
  ...
  creating shared understanding through clear communication, visual thinking, and collaborative
  problem-solving."
- **Engineering Manager:** "Engineering Manager with 15+ years leading software teams across
  product-led organisations. Genuine technical depth (started as software engineer and systems
  architect) combined with a strong product mindset and a track record of building high-performing
  teams."
- **Scrum Master / Agile:** "Hands-on Agile practitioner with 15+ years working alongside
  full-stack engineering teams… combines coaching ability and high EQ with the technical fluency
  to earn credibility with engineers quickly. Consistently shifted teams from chaotic to
  predictable without adding unnecessary process."
- **AI PM:** "Project & Technical Delivery Leader with 10+ years managing complex software
  projects, including large cross-cutting AI initiatives."
- **Product:** "Product & Technical Delivery leader with 10+ years bridging product, design, and
  engineering. Proven track record scaling SaaS and marketplace businesses."
- **Ops leader / Chief of Staff:** "Technical program and operations leader with 15+ years bridging
  product, design, and engineering… eager to step into a Chief of Staff role that blends strategic
...
- **AI / ML role** → expand Xero *AI for Customers* + intelliHR *NLP people analytics*; flag both.
- **Payments / fintech role** → expand Xero *US Bills Integration*, Console/Reapit *payments
  integration*, Emedia *booking/payment systems*.
- **Booking / travel / ticketing role** → expand 2sol *Flight Centre platform* + Emedia *event
  ticketing*; the Project Manager resume flags both with 🔴.
- **Eng-management role** → expand Go1 *squad of 10* (hiring/performance) + 2sol *practice
...
- **Head of Delivery role (SaaS/AI)** → lead with Xero *API Program* (dozens of teams, delivery
  ...
  hyper-growth) + intelliHR *NLP people-analytics* (AI delivery, ethical guardrails, internal pilots).
...
- **Health IT / clinical SaaS transformation PM role** → lead with Xero *API Program / Supergraph* (platform modernisation at scale - same archetype as on-prem to cloud: migrating from legacy architecture without disrupting existing products, EGM-level reporting, Unified Burndown as agreed launch schedule) as the primary platform-transformation anchor + Suncorp (APRA-regulated, compliance-embedded delivery, working directly with Infrastructure, Security, Legal, and Business stakeholders - closest regulated-industry analogue to clinical/TGA compliance) + Go1 (SaaS product squad from initiation to launch, delivery operating model built from scratch). Headline: "Project Manager". Summary angle: "15+ years leading cross-functional delivery programs including SaaS, platform modernisation, and highly regulated industries." Gap acknowledgement: clinical/health software domain is new - use "new-industry gap + environment match pivot": state plainly ("I have not worked in clinical or health software before"), pivot to regulated environment match (APRA-regulated Suncorp, compliance-critical delivery, existing product customers depend on). Do NOT claim TGA/clinical safety expertise - frame as "I work with clinical safety SMEs, integrating them into delivery rather than being the subject-matter expert." The JD's own language ("exciting start to your Health IT career") signals openness to candidates from adjacent regulated industries.

- **Government / Data Platform & Integration PM role** (state government, Databricks-based platform) → lead Xero *API Program/Supergraph* (federated integration platform, EGM-level governance, Unified Burndown as cross-domain migration tracker) + Suncorp *telephony/data platform migration* (compliance-critical, four teams incl. offshore, data governance) + Emedia *ticketing/booking/payment architecture* (production SQL, capacity planning) as the three anchors, flagged inline with a 🚩 "Data Platform and Integration Experience" marker (distinct from the 🔴 flag used elsewhere — pick one flag style per document, don't mix). Headline: plain "Project Manager" (the JD's own role title). Acknowledge the Databricks tool-gap directly and plainly in the cover letter — pivot to ETL/data-pipeline delivery + SLO/governance fluency + software-engineering background as the "will ramp fast" evidence, same device family as the technical-domain-gap pivot but naming the specific tool rather than a domain.
...
- **Gave-away-the-hard-problem proof** (new 2026-07-16, first used for Digital Native's Engineering
